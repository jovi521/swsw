package com.cdyw.swsw.data.common.listener.cldas1km;
 ...
 */
@Component
public class Cldas1kmFileListener extends FileAlterationListenerAdaptor {
    ...
    // 采用构造函数注入服务
    @Autowired
    public Cldas1kmFileListener(Cldas1kmService cldas1kmService) {
    ...
    public void onFileCreate(File file) {
        ...
        try {
            ...
            Thread.sleep(5000);
            cldas1kmService.getCldas1kmData(file.getAbsolutePath());
