...
public class RadarWindProfileBaseNotifyClass extends Thread {
    ...
    public RadarWindProfileBaseNotifyClass(String sourcePath, RadarWindProfileService radarWindProfileService) {
    ...
    class DynamicInsertFile implements Runnable {
        ...
        @Override
        public void run() {
            int size = radarWindProfileService.insertRadarWindProfileBase(new File(filePath));
