...
public class RadarWeatherParseNotifyClass extends Thread {
    ...
    public RadarWeatherParseNotifyClass(String sourcePath, RadarWeatherService radarWeatherService) {
    ...
    class DynamicInsertFile implements Runnable {
        ...
        @Override
        public void run() {
            int size = radarWeatherService.insertRadarWeatherParse(new File(filePath));
            logger.info(TypeEnum.TYPE_RADAR_WEATHER.getName() + " onFileCreated: " + size + " 条数据");
        }
    }
