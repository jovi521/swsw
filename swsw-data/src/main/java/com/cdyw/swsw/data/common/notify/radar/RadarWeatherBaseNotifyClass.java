...
public class RadarWeatherBaseNotifyClass extends Thread {
    ...
    public RadarWeatherBaseNotifyClass(String sourcePath, RadarWeatherService radarWeatherService) {
    ...
    class DynamicInsertFile implements Runnable {
        ...
        @Override
        public void run() {
            int size = radarWeatherService.insertRadarWeatherBase(new File(filePath));
