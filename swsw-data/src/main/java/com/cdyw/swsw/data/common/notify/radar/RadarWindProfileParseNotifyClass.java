...
public class RadarWindProfileParseNotifyClass extends Thread {
    ...
    public RadarWindProfileParseNotifyClass(String sourcePath, RadarWindProfileService radarWindProfileService) {
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (!StringUtils.isEmpty(filePath)) {
                    int size = radarWindProfileService.insertRadarWindProfileParse(new File(filePath));
