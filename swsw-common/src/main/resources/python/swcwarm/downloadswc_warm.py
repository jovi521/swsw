...
def download_swc_warm(mdfs_path, save_path, ipconfig_path):
...
if __name__ == '__main__':
    ...
    mdfs_path = r'mdfs:///SWC_WARM/RAIN12/20120708.012'
    save_path = r'D:/Data/satellite_parse/FY4A/20201127/CHANNEL12'
    ipconfig_path = 'ip_port.txt'

    # mdfs_path = r'mdfs:///CLDAS_1KM/WIND/10M_ABOVE_GROUND/20120317.000'
    # save_path = r'D:/Data/cldas_1km_base/20201203/WINDFIELD'
    # ipconfig_path = 'D:/svn-projects/SourceCode/swsw/swsw-common/src/main/resources/ip_port.txt'
    download_swc_warm(mdfs_path, save_path, ipconfig_path)
