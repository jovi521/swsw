...
import com.cdyw.swsw.system.app.config.TokenException;
import com.cdyw.swsw.system.app.config.TokenExpiredException;
...
//            System.out.println("token = " + token);
            ...
            try {
                ...
                new TokenException("令牌错误，请重新登录。" + e.getMessage());
            }
            if (check) {
                new TokenExpiredException("令牌过期，请重新登录。。");
            } else {
                //通过令牌获取用户名称
                ...
                if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                    ...
                    try {
                        ...
                        new TokenException("验证token无效:" + e.getMessage());
                    }
                    if (validata) {
